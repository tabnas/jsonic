...
lists, which is the reader-facing set: 19 pages in this repository. It
...
directory. The design notes, the feasibility reports and the defect
ledgers are working documents, and they are out.
...
a clean run over the gated set: 518 alerts across 19 files. Those
