import { TabnasError as JsonicError, util, S, OPEN, CLOSE, BEFORE, AFTER, EMPTY, SKIP, makeLex, makeParser, makeToken, makePoint, makeRule, makeRuleSpec, makeFixedMatcher, makeSpaceMatcher, makeLineMatcher, makeStringMatcher, makeCommentMatcher, makeNumberMatcher, makeTextMatcher } from '@tabnas/parser';
...
import { jsonicPlugin, registerJsonicGrammar } from './grammar';
...
export { Jsonic as Jsonic, JsonicError, jsonicPlugin as jsonic, registerJsonicGrammar, util, make, makeToken, makePoint, makeRule, makeRuleSpec, makeLex, makeParser, makeFixedMatcher, makeSpaceMatcher, makeLineMatcher, makeStringMatcher, makeCommentMatcher, makeNumberMatcher, makeTextMatcher, OPEN, CLOSE, BEFORE, AFTER, EMPTY, SKIP, S, root, };
